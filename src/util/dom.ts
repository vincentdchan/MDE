...
export namespace DomHelper {
    ...
    export namespace Generic {
        ...
        export function elem<T extends HTMLElement>(elemName : string, className?: string, props?: any) : T {
            let _elm = <T>document.createElement(elemName);
        ...
        export interface IDOMWrapper<T extends HTMLElement> {
        ...
        export function isIDOMWrapper(object: any) : object is IDOMWrapper<any> {
            return (typeof object === "object") 
                && (object.element && object.addEventListener && object.appendTo)
                && (typeof object.element === "function" 
                    && typeof object.addEventListener === "function"
        ...
        export class AppendableDomWrapper<T extends HTMLElement> implements IDOMWrapper<T> {

            protected _dom : T;

            constructor(elemName: string, className? : string, props? : any) {
                this._dom = <T>elem(elemName, className, props);
            }
        ...
        export class ResizableElement<T extends HTMLElement> extends AppendableDomWrapper<T> {
        ...
        class PositionElement<T extends HTMLElement> extends ResizableElement<T> {
        ...
        export class FixedElement<T extends HTMLElement> extends PositionElement<T> {
        ...
        export class AbsoluteElement<T extends HTMLElement> extends PositionElement<T> {
