 ...
 * ## Added at v0.1.0
 * 
 * Replace `DomHelper`, do **not** use `DomHelper` to generate DOM anymore,
 * use the *typescript-domhelper* library.
 * 
 * The `Generic` namespace is also abandoned.
 */
export namespace DomWrapper {
...
/**
 * ## Abandoned at v 0.1.0
 * 
 * replaced by `DomWrapper`
 */
namespace DomHelper {
